                                ...
                                <div class="card-body" style="height: 185px;">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between pt-3">
                                        <div class="d-flex flex-column">
                                            ...
                                            <a href="../../Web_bds_v2.0/thongtinbds/detail?thongtinbdsid=${t.idbds}" style="text-decoration: none;"><div class="btn btn-outline-primary">Chi tiết</div></a>
                                            <c:set var="num" value="/admin"/>
                                            <c:if test="${sessionScope.account.vaitro.vaitro==num}">
                                            <a href="../../Web_bds_v2.0/thongtinbds/delete?thongtinbdsid=${t.idbds}" style="text-decoration: none;" class="btn btn-outline-danger">xóa</a>
                                            <a href="../../Web_bds_v2.0/thongtinbds/update?thongtinbdsid=${t.idbds}" style="text-decoration: none;" class="btn btn-outline-success">Sửa</a>
                                            </c:if>
                                    </div>
                                </div>
                            </div>
